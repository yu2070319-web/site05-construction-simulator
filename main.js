...
window.siteDiagnostics={renderer,scene,camera,controls,selectable,revision:THREE.REVISION,selectObject,clearSelection,simulator,cranes,vehicles,physicsReady:true,physicsWorld,cranePhysics};
